...
export async function apiUpdateGroupChat(chatId, data) {
  ...
  return await axios.put(APP_API_URL + `/chats/group/update/${chatId}`, formData)
}
...
export async function apiRemoveGroupChatMember(chatId, memberId) {
  return await axios.delete(APP_API_URL + `/chats/group/${chatId}/members/remove/${memberId}`)
}
...
export async function apiUpdateChatMessage(chatId, messageId, content) {
  return await axios.patch(APP_API_URL + `/chats/${chatId}/messages/update/${messageId}`, {
    content,
  })
}

export async function apiDeleteChatMessage(chatId, messageId) {
  return await axios.delete(APP_API_URL + `/chats/${chatId}/messages/delete/${messageId}`)
}
...
export async function apiCreateVoiceChatMessage(chatId, voiceBlob) {
  ...
  return await axios.post(APP_API_URL + `/chats/${chatId}/messages/create-voice`, formData)
}

export async function apiCreateImageChatMessage(chatId, imageFile) {
  const formData = new FormData()
  formData.append('image', imageFile)
  return await axios.post(APP_API_URL + `/chats/${chatId}/messages/create-image`, formData)
}
export async function apiTogglePinChat(chatId) {
  return await axios.post(APP_API_URL + `/chats/${chatId}/pin`)
}

export async function apiToggleMuteChat(chatId) {
  return await axios.post(APP_API_URL + `/chats/${chatId}/mute`)
}
