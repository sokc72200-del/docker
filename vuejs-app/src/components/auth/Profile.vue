              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  <div class="mt-1">
                    ...
                    <a type="button" @click="onDeleteImage()" class="m-1 btn btn-danger btn-sm"
                      ><i class="fas fa-trash"></i
                    ></a>
                    <a type="button" @click="onResetImage()" class="m-1 btn btn-secondary btn-sm"
                    ...
                    <form @submit.prevent="savePassword" class="form-horizontal">
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          ...
                          <button type="submit" class="mx-3 btn btn-outline-primary">Save</button>
                        </div>
                      </div>
                    </form>
                  </div>
...
async function savePassword() {
  try {
    ...
    const response = userStore.password_null
      ? await apiCreatePassword(user.new_password, user.new_password_confirmation)
...
const imageChanged = computed(() => tempImage.value !== (profileImage.value ?? emptyImage))
