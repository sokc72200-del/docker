            ...
            <div class="dataTables_paginate paging_simple_numbers">
              <ul class="pagination">
                ...
                <template v-for="pageNum in lastPage" :key="pageNum">
                  <li
                    v-if="pageNum >= currentPage - sidePage && pageNum <= currentPage + sidePage"
                ...
                >
                  <a
                    @click.prevent="currentPage < lastPage && changePage(currentPage + 1)"
                    role="button"
                    tabindex="0"
                    class="page-link"
                ...
                >
                  <a
                    @click.prevent="currentPage < lastPage && changePage(lastPage)"
                    role="button"
                    tabindex="0"
                    class="page-link"
                    :style="{ cursor: currentPage === lastPage ? 'not-allowed' : 'pointer' }"
