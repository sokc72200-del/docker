          ...
          <div class="card-body box-profile">
            <form @submit.prevent="updateGroup">
              ...
              <div class="form-group">
                <label>Name</label>
                <input
                  :disabled="chatType === 'personal' || (chatType === 'group' && !isAdmin)"
                  type="text"
                  class="form-control"
                  v-model="chat.name"
              ...
              <template v-if="chatType === 'group'">
                ...
                <div class="form-group">
                  <button type="button" @click="leaveGroupChat" class="btn btn-warning btn-block">
                    Leave Chat
                  </button>
                </div>
                <div class="form-group" v-if="isAdmin">
                  <button type="button" @click="deleteChat" class="btn btn-danger btn-block">
                    Delete Chat
                  </button>
                </div>
              </template>
...
watch(
  ...
  async (newChatId) => {
    ...
    if (chatType.value === 'group') {
      ...
      isAdmin.value =
        members.value.some(
          (member) => member.user.id === userStore.id && member.role === 'admin',
        ) || false
    }
  },
  { immediate: true },
